...
exports.index = async function(req, res) {
    ...
    try {
        ...
        res.render('index', {
            title: 'ztncui',
            navigate: navigate,
            error: 'ERROR getting ZT status: ' + err
        });
    }
};
...
exports.member_delete = async function(req, res) {
    ...
    try {
        ...
        res.render('member_delete', {
            title: 'Delete member from ' + network.name,
            navigate: navigate,
            network: network,
            member: member
        });
...
exports.delete_ip = async function(req, res) {
    ...
    try {
        ...
        res.render('ipAssignments', {
            title: 'ipAssignments ' + network.name,
            navigate: navigate,
